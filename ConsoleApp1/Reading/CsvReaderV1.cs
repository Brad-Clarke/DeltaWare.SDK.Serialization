...
{
    public sealed class CsvReaderV1 : ICsvReader, IDisposable
    {
        ...
        public CsvReaderV1(StreamReader baseStream, ICsvReaderSettings settings = null)
        {
            _baseStream = baseStream;
            _readerSettings = settings ?? CsvReaderSettings.Default;
        }

        public CsvReaderV1(StreamReader baseStream, Action<CsvReaderSettings> settingsBuild)
        {
            _baseStream = baseStream;
        ...
        public CsvReaderV1(string value, ICsvReaderSettings settings = null)
        {
        ...
        public CsvReaderV1(string value, Action<CsvReaderSettings> settingsBuild)
        {
            MemoryStream stream = new MemoryStream();
            StreamWriter writer = new StreamWriter(stream);
